...
export default function Achats(){
 ...
 return <div><div className="breadcrumb">Stocks / Fournisseurs & Achats</div><div className="page-heading page-heading-actions"><div><span className="eyebrow">Approvisionnement fournisseur</span><h1>Fournisseurs & Achats</h1><p>Regroupez les besoins du Lot L en commandes et réceptionnez-les dans le stock.</p></div><div className={styles.headingActions}><Link href="/achats/pilotage">Pilotage achats</Link><Link href="/achats/tarifs">Tarifs articles</Link><Button variant="secondary" onClick={load}><RefreshCcw size={17}/>Actualiser</Button></div></div>
