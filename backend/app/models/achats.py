...
class CommandeAchat(Base):
    ...
    date_premiere_reception: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    date_reception_finale: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    commentaire: Mapped[str | None] = mapped_column(Text, nullable=True)
...
class LigneCommandeAchat(Base):
    ...
    date_premiere_reception: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    date_derniere_reception: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
